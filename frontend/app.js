...
const ui = {
    ...
    renderScores(analysis) {
        if (analysis.design_score === undefined && analysis.freshness_trust_score === undefined) return '';
        return `
            <div class="result-block scores-row" style="display:flex; gap:24px;">
                ...
                ` : ''}
                ${analysis.freshness_trust_score !== undefined ? `
                    <div>
                        <h3>Доверие к свежести</h3>
                        <span class="score-value">${analysis.freshness_trust_score}/10</span>
                    </div>
                ` : ''}
            </div>
        `;
            ...
            ${analysis.freshness_trust_score !== undefined ? `
                <div class="result-block">
                    ...
                    <div class="score-display">
                        <span class="score-value">${analysis.freshness_trust_score}/10</span>
                        <div class="score-bar">
                            <div class="score-fill" style="width: ${(analysis.freshness_trust_score / 10) * 100}%"></div>
                        </div>
                    </div>
                </div>
            ` : ''}
